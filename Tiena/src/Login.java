...
ImageIcon Img = new ImageIcon(getClass().getResource("/Iconos/login.png")); 
...
super.paintComponent(grafico);
    ...
    public Login() {
        ...
        Login.Imagen Imagen = new Login.Imagen();
        Panel.add(Imagen);
        Panel.repaint();
    }
    ...
    private void initComponents() {
        ...
        btnRegistrarse.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Add User Male Filled-26.png"))); // NOI18N
        ...
        btnIngresar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/icons8-Enter-26.png"))); // NOI18N
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
       try {
           ...
           //RMI metodo
            String responce = RMI.loggin(jTextField2.getText(), jTextField1.getText());
            //validacion
            if (responce.equals("1")) {
               Menu m = new Menu();
               m.show();
               Login.this.setVisible(false);
               JOptionPane.showMessageDialog(this, "Bienvenido "+jTextField2.getText());
           }else{
                JOptionPane.showMessageDialog(this, "Error, pruebe de nuevo porfavor.");
            }
        }catch (Exception ex){
